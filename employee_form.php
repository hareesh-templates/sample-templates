...
<link rel="stylesheet" href="animate.css">
	...
	<?php include("header.php")?>
		...
		<div class="container">
  			...
  			<h1 class="text-center1">Employees</h1>
  			<br><br>
   			<form action="employee_add.php" method="post" class="form-group">
   			...
   			<div class="container">
   				<div class="row">
    				...
    				<div class="col-sm-2 offset-sm-1">
    					...
    					<input name="designation" id="designation" type="text" placeholder="designation" class="form-control form-group designation" onkeyup="return clear_2()">
					...
					<div class="col-sm-2 offset-sm-1">
    					...
    					<input name="salary" id="salary" type="text" placeholder="salary" class="form-control form-group salary" onkeyup="return clear_2()">
